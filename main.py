"""Character creation and training for game."""
...
def defence(char_name: str, char_class: str) -> str:
    """Calculate how much damage was blocked."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Show if the special ability was used."""
    if char_class == 'warrior':
...
def main() -> None:
    """Start the game, give the name to the character."""
